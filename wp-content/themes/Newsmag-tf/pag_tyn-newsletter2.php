<?php
/*
Template Name: TYN NEWSLETTER 2
*/
...
<button onclick="copyToClipboard('#wrapper')">Copiar Newsletter</button>
...
<tr>
<td width="500px">
<select id="Combo9" onchange="UpCombo9()">
<option value="0"><?=$tit[0];?></option>
<option value="1"><?=$tit[1];?></option>
<option value="2"><?=$tit[2];?></option>
<option value="3"><?=$tit[3];?></option>
...
<option value="7"><?=$tit[7];?></option>
<option value="8"><?=$tit[8];?></option>
<option value="9" selected><?=$tit[9];?></option>
<option value="10"><?=$tit[10];?></option>
<option value="11"><?=$tit[11];?></option>
<option value="12"><?=$tit[12];?></option>
<option value="13"><?=$tit[13];?></option>
...
<td width="500px">
<select id="Combo10" onchange="UpCombo10()">
<option value="0"><?=$tit[0];?></option>
<option value="1"><?=$tit[1];?></option>
<option value="2"><?=$tit[2];?></option>
<option value="3"><?=$tit[3];?></option>
...
<option value="8"><?=$tit[8];?></option>
<option value="9"><?=$tit[9];?></option>
<option value="10" selected><?=$tit[10];?></option>
<option value="11"><?=$tit[11];?></option>
<option value="12"><?=$tit[12];?></option>
<option value="13"><?=$tit[13];?></option>
<option value="14"><?=$tit[14];?></option>
...
<!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="310" height="300" bgcolor="#f6f6f6" valign="top">                    
					<tr>
                        <td height="95" valign="top" style="padding: 5px 5px 0 5px;">
						<h1 id="Titulo9" style="color: #c9000a; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #c9000a" href="<?=$url[8];?>"><?=$tit[8];?></a></h1></td></tr>
					<tr>
						<td id="Imagen9" height="200px" valign="top" style="padding: 2px 5px 5px 5px;"><a href="<?=$url[8];?>"><img src="<?=$post_image[8];?>" width="297" height="208"/></a>
						</td>
                    </tr>
                </table>
            </div>
...
<!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="310" height="300" bgcolor="#f6f6f6" valign="top">                    
					<tr>
                        <td height="95" valign="top" style="padding: 5px 5px 0 5px;">
							<h1 id="Titulo10" style="color: #c9000a; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #c9000a" href="<?=$url[9];?>"><?=$tit[9];?></a></h1></td></tr>
							<tr><td id="Imagen10" height="200px" valign="top" style="padding: 2px 5px 5px 5px;"><a href="<?=$url[9];?>"><img src="<?=$post_image[9];?>" width="297" height="208"/></a>
						</td>
                    </tr>
                </table>
            </div>
...
<!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
				...
				<tr>
					...
					<td id="Titulo5" height="60" valign="top" style="width: 260px; text-align: left"><a style="color: #c9000a" href="<?=$url[4];?>"><span id="Titulo5" style="color: #c9000a"><?=$tit[4];?></span></a></td>
				</tr>
				<tr>
					...
					<td id="Titulo6" height="60" valign="top" style="width: 260px; text-align: left"><a style="color: #c9000a" href="<?=$url[5];?>"><span id="Titulo6" style="color: #c9000a"><?=$tit[5];?></span></a></td>
				</tr>
				<tr>
					...
					<td id="Titulo7" height="60" valign="top" style="width: 260px; padding: 0 5px 0 5px; text-align: left"><a style="color: #c9000a" href="<?=$url[6];?>"><span id="Titulo7" style="color: #c9000a"><?=$tit[6];?></span></a></td>
				</tr>
				<tr>
					...
					<td id="Titulo8" height="60" valign="top" style="width: 260px; height: 25%; text-align: left"><a style="color: #c9000a" href="<?=$url[7];?>"><span id="Titulo8" style="color: #c9000a"><?=$tit[7];?></span></a></td>
				</tr>
			</table>
            </div>
            <!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top;">
                <table width="310">
                    <tr>
						...
						<a style="color: #c9000a" href="http://www.tynmagazine.com/" target="blank"><span style="color: #c9000a">TYN MAGAZINE</a></span>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #c9000a" href="http://www.tynchannel.com/" target="blank"><span style="color: #c9000a">TYN CHANNEL</a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #c9000a" href="http://www.tyniot.com/" target="blank"><span style="color: #c9000a">TYN IoT</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #c9000a" href="http://www.tynmobile.com/" target="blank"><span style="color: #c9000a">TYN MOBILE</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #c9000a" href="http://www.tynsecurity.com/" target="blank"><span style="color: #c9000a">TYN SECURITY</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #c9000a" href="http://www.tyninvestment.com/" target="blank"><span style="color: #c9000a">TYN INVESTMENT</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #c9000a" href="http://www.tyncloud.com/" target="blank"><span style="color: #c9000a">TYN CLOUD</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #c9000a" href="http://www.tynentrepreneurs.com/" target="blank"><span style="color: #c9000a">TYN ENTREPRENEURS</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #c9000a" href="http://www.tyninvestment.com/" target="blank"><span style="color: #c9000a">TYN MOBILE MONEY</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #c9000a" href="http://www.tynmobilemoney.com/" target="blank"><span style="color: #c9000a">TYN BRASIL</span></a></p>
						</td>
                    </tr>
                </table>
            </div>
...
function UpCombo9()
{
var e = document.getElementById("Combo9");
var SelCombo9 = e.options[e.selectedIndex].value;
document.getElementById("Titulo9").innerHTML = '<a style="color: #c9000a" href="' + url[SelCombo9] + '">' + tit[SelCombo9] + '</a>';
document.getElementById("Imagen9").innerHTML = '<a href="' + url[SelCombo9] + '">' +'<img src="' + img[SelCombo9] + '" style="width: 100%"></a>';
}


function UpCombo10()
{
var e = document.getElementById("Combo10");
var SelCombo10 = e.options[e.selectedIndex].value;
document.getElementById("Titulo10").innerHTML = '<a style="color: #c9000a" href="' + url[SelCombo10] + '">' + tit[SelCombo10] + '</a>';
document.getElementById("Imagen10").innerHTML = '<a href="' + url[SelCombo10] + '">' +'<img src="' + img[SelCombo10] + '" style="width: 100%"></a>';
}
