...
/* RECUPERAR POSTS DE TYN MAGAZINE */
switch_to_blog(3);
$args = array(			
			'post_status'	=> 'publish',
			'numberposts'	=> 70,
...
/* RECUPERAR POSTS DE TYN CHANNEL */
/*switch_to_blog(5);
$args = array(			
			'post_status'	=> 'publish',
			'numberposts'	=> 10,
...
<div style="width: 100%; margin: 0; padding: 10px 0 10px; border-bottom: 2px #c9000a solid; position: fixed; top: 0; background: #fff; display: block; height: 120px">
...
<option value="51"><?=$tit[51];?></option>
<option value="52"><?=$tit[52];?></option>
<option value="53"><?=$tit[53];?></option>
<option value="54"><?=$tit[54];?></option>
<option value="55"><?=$tit[55];?></option>
<option value="56"><?=$tit[56];?></option>
<option value="57"><?=$tit[57];?></option>
<option value="58"><?=$tit[58];?></option>
<option value="59"><?=$tit[59];?></option>
<option value="60"><?=$tit[60];?></option>
<option value="61"><?=$tit[61];?></option>
<option value="62"><?=$tit[62];?></option>
<option value="63"><?=$tit[63];?></option>
<option value="64"><?=$tit[64];?></option>
<option value="65"><?=$tit[65];?></option>
<option value="66"><?=$tit[66];?></option>
<option value="67"><?=$tit[67];?></option>
<option value="68"><?=$tit[68];?></option>
<option value="69"><?=$tit[69];?></option>
<option value="70"><?=$tit[70];?></option>
</select>
            ...
            <div style="width: 310px; display: inline-block; vertical-align: top; height: 95px">
                <table width="100%" height="100%">
                    <tr>
						...
						<a href="http://www.tynmagazine.com" alt="TyN Magazine Logo" target="_blank"><img src="http://tynmedia.com/newsletters/tyn/logo-rojo.png"></a>
						</td>
					</tr> 
                </table>
            </div>
                ...
                <table width="100%" height="90">
                    <tr>                        
							...
							<table border=0 cellpadding=2 cellspacing=0 align="right">
								<tr>
									<td><a href="http://www.facebook.com/tynmagazine" alt="TyN Magazine en Facebook" target="_blank"><img src="http://tynmedia.com/newsletters/tyn/icons/facebook.png"></a></td>
									<td><a href="http://www.twitter.com/tynmagazine" alt="TyN Magazine en Twitter" target="_blank"><img src="http://tynmedia.com/newsletters/tyn/icons/twitter.png"></a></td>
									<td><a href="http://plus.google.com/+Tyniotcom/posts" alt="TyN Magazine en Google+" target="_blank"><img src="http://tynmedia.com/newsletters/tyn/icons/googleplus.png"></a></td>
									...
									<td><a href="http://www.tynmagazine.com/feed" alt="Fedd RSS de TyN Magazine" target="_blank"><img src="http://tynmedia.com/newsletters/tyn/icons/rss.png"></a></td>
								</tr>
							</table>
							</tr>
				</table>
...
<!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="310" height="300" bgcolor="#f6f6f6" valign="top">
					<tr>
						...
						<h1 id="Titulo1" style="color: #c9000a; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #c9000a" href="<?=$url[0];?>"><?=$tit[0];?></a></h1>
						</td>
					</tr>
					<tr>
						<td id="Imagen1" height="200px" valign="top" style="padding: 2px 5px 5px 5px;"><a style="color: #c9000a" href="<?=$tit[0];?>"><img src="<?=$post_image[0];?>" width="297" height="208"/></a>
						</td>
                    </tr>
                </table>
            </div>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
				...
				<tr>
                        <td height="95" valign="top" style="padding: 5px 5px 0 5px; width: 294px;">
						<h1 id="Titulo2" style="color: #c9000a; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #c9000a" href="<?=$url[1];?>"><?=$tit[1];?></a></h1>
						</td>
					</tr>
					<tr>
...
<!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="310" height="300" bgcolor="#f6f6f6" valign="top">                    
					<tr>
						...
						<h1 id="Titulo3" style="color: #c9000a; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #c9000a" href="<?=$url[2];?>"><?=$tit[2];?></a></h1></td></tr>
					<tr>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="310" height="300" bgcolor="#f6f6f6" valign="top">                    
					<tr>
                        <td height="95" valign="top" style="padding: 5px 5px 0 5px;">
							<h1 id="Titulo4" style="color: #c9000a; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #c9000a" href="<?=$url[3];?>"><?=$tit[3];?></a></h1></td></tr>
...
<!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="310" height="300" bgcolor="#f6f6f6" valign="top">                    
					<tr>
                        <td height="95" valign="top" style="padding: 5px 5px 0 5px;">
						<h1 id="Titulo5" style="color: #c9000a; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #c9000a" href="<?=$url[4];?>"><?=$tit[4];?></a></h1></td></tr>
					<tr>
						<td id="Imagen5" height="200px" valign="top" style="padding: 2px 5px 5px 5px;"><a href="<?=$url[4];?>"><img src="<?=$post_image[4];?>" width="297" height="208"/></a>
						</td>
                    </tr>
                </table>
            </div>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="310" height="300" bgcolor="#f6f6f6" valign="top">                    
					<tr>
                        <td height="95" valign="top" style="padding: 5px 5px 0 5px;">
							<h1 id="Titulo6" style="color: #c9000a; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #c9000a" href="<?=$url[5];?>"><?=$tit[5];?></a></h1></td></tr>
							<tr><td id="Imagen6" height="200px" valign="top" style="padding: 2px 5px 5px 5px;"><a href="<?=$url[5];?>"><img src="<?=$post_image[5];?>" width="297" height="208"/></a>
						</td>
                    </tr>
                </table>
            </div>
...
<!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="310" height="300" bgcolor="#f6f6f6" valign="top">                    
					<tr>
                        <td height="95" valign="top" style="padding: 5px 5px 0 5px;">
						<h1 id="Titulo7" style="color: #c9000a; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #c9000a" href="<?=$url[6];?>"><?=$tit[6];?></a></h1></td></tr>
					<tr>
						<td id="Imagen7" height="200px" valign="top" style="padding: 2px 5px 5px 5px;"><a href="<?=$url[6];?>"><img src="<?=$post_image[6];?>" width="297" height="208"/></a>
						</td>
                    </tr>
                </table>
            </div>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="310" height="300" bgcolor="#f6f6f6" valign="top">                    
					<tr>
                        <td height="95" valign="top" style="padding: 5px 5px 0 5px;">
							<h1 id="Titulo8" style="color: #c9000a; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #c9000a" href="<?=$url[7];?>"><?=$tit[7];?></a></h1></td></tr>
							<tr><td id="Imagen8" height="200px" valign="top" style="padding: 2px 5px 5px 5px;"><a href="<?=$url[7];?>"><img src="<?=$post_image[7];?>" width="297" height="208"/></a>
						</td>
                    </tr>
                </table>
            </div>
...
<!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="100%">
                    <tr>
                        <td style="text-aling: center;"><a href='http://104.131.142.242/adserver/www/delivery/ck.php?zoneid=148' target='_blank'><img src='http://104.131.142.242/adserver/www/delivery/avw.php?zoneid=148&amp;cb=INSERT_RANDOM_NUMBER_HERE' border='0' alt='' style="width: 300px; height: 250px;"></a></td>
                    </tr>
                </table>
            </div>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="100%">
                    <tr>
                        <td style="text-aling: center;"><a href='http://104.131.142.242/adserver/www/delivery/ck.php?zoneid=105' target='_blank'><img src='http://104.131.142.242/adserver/www/delivery/avw.php?zoneid=105&amp;cb=INSERT_RANDOM_NUMBER_HERE' border='0' alt='' style="width: 300px; height: 250px;"></a></td>
                    </tr>
                </table>
            </div>
...
<!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="100%">
                    <tr>
                        <td style="text-aling: center;"><a href='http://104.131.142.242/adserver/www/delivery/ck.php?zoneid=107' target='_blank'><img src='http://104.131.142.242/adserver/www/delivery/avw.php?zoneid=107&amp;cb=INSERT_RANDOM_NUMBER_HERE' border='0' alt='' style="width: 300px; height: 250px;"></a></td>
                    </tr>
                </table>
            </div>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="100%">
                    <tr>
                        <td style="text-aling: center;"><a href='http://104.131.142.242/adserver/www/delivery/ck.php?zoneid=106' target='_blank'><img src='http://104.131.142.242/adserver/www/delivery/avw.php?zoneid=106&amp;cb=INSERT_RANDOM_NUMBER_HERE' border='0' alt='' style="width: 300px; height: 250px;"></a></td>
                    </tr>
                </table>
            </div>
...
document.getElementById("Titulo1").innerHTML = '<a style="color: #c9000a" href="' + url[SelCombo1] + '">' + tit[SelCombo1] + '</a>';
...
document.getElementById("Titulo2").innerHTML = '<a style="color: #c9000a" href="' + url[SelCombo2] + '">' + tit[SelCombo2] + '</a>';
...
document.getElementById("Titulo3").innerHTML = '<a style="color: #c9000a" href="' + url[SelCombo3] + '">' + tit[SelCombo3] + '</a>';
...
document.getElementById("Titulo4").innerHTML = '<a style="color: #c9000a" href="' + url[SelCombo4] + '">' + tit[SelCombo4] + '</a>';
...
document.getElementById("Titulo5").innerHTML = '<a style="color: #c9000a" href="' + url[SelCombo5] + '">' + tit[SelCombo5] + '</a>';
document.getElementById("Imagen5").innerHTML = '<a href="' + url[SelCombo5] + '"><img src="' + img[SelCombo5] + '" style="width: 100%"></a>';
}
...
document.getElementById("Titulo6").innerHTML = '<a style="color: #c9000a" href="' + url[SelCombo6] + '">' + tit[SelCombo6] + '</a>';
document.getElementById("Imagen6").innerHTML = '<a href="' + url[SelCombo6] + '"><img src="' + img[SelCombo6] + '" style="width: 100%"></a>';
}
...
document.getElementById("Titulo7").innerHTML = '<a style="color: #c9000a" href="' + url[SelCombo7] + '">' + tit[SelCombo7] + '</a>';
document.getElementById("Imagen7").innerHTML = '<a href="' + url[SelCombo7] + '"><img src="' + img[SelCombo7] + '" style="width: 100%"></a>';
}
...
document.getElementById("Titulo8").innerHTML = '<a style="color: #c9000a" href="' + url[SelCombo8] + '">' + tit[SelCombo8] + '</a>';
document.getElementById("Imagen8").innerHTML = '<a href="' + url[SelCombo8] + '"><img src="' + img[SelCombo8] + '" style="width: 100%"></a>';
}</script>