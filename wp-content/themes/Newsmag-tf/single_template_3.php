                ...
                <div class="td-pb-span12">
                    <div class="td-post-header td-pb-padding-side">
                        ...
                        <header>
                            ...
                            <div class="meta-info">
								<?php
									$influencer_posts = get_field('influencer_posts');
									if ($influencer_posts) {
										foreach( $influencer_posts as $post): setup_postdata($post);
											echo '<div class="td-post-author-name">By <a href="'. get_the_permalink() .'">'. get_the_title() .'</a> - </div>';
										endforeach;
										wp_reset_postdata();
									} else {
