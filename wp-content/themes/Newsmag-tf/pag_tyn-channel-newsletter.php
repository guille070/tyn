<?php
/*
Template Name: TYN CHANNEL NEWSLETTER
*/
...
<div style="width: 100%; margin: 0; padding: 10px 0 10px; border-bottom: 2px #FF114d solid; position: fixed; top: 0; background: #fff; display: block; height: 120px">
            ...
            <div style="width: 310px; display: inline-block; vertical-align: top; height: 95px">
                <table width="100%" height="100%">
                    <tr>
						...
						<a href="http://www.tynchannel.com" alt="TyN Channel Logo" target="_blank"><img src="http://tynmedia.com/newsletters/tyn/logo-channel.png"></a>
						</td>
					</tr> 
                </table>
            </div>
                ...
                <table width="100%" height="90">
                    <tr>                        
							...
							<table border=0 cellpadding=2 cellspacing=0 align="right">
								<tr>
									<td><a href="https://www.facebook.com/pages/TyN-Channel/100664150027397" alt="TyN Channel en Facebook" target="_blank"><img src="http://tynmedia.com/newsletters/tyn/icons/facebook.png"></a></td>
									<td><a href="http://www.twitter.com/tynchannel" alt="TyN Channel en Twitter" target="_blank"><img src="http://tynmedia.com/newsletters/tyn/icons/twitter.png"></a></td>
									<td><a href="https://plus.google.com/+Tynchannel/posts" alt="TyN Channel en Google+" target="_blank"><img src="http://tynmedia.com/newsletters/tyn/icons/googleplus.png"></a></td>
									...
									<td><a href="http://www.tynchannel.com/feed" alt="Feed RSS de TyN Channel" target="_blank"><img src="http://tynmedia.com/newsletters/tyn/icons/rss.png"></a></td>
								</tr>
							</table>
							</tr>
				</table>
...
<!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="310" height="300" bgcolor="#f6f6f6" valign="top">
					<tr>
						...
						<h1 id="Titulo1" style="color: #FF114d; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #FF114d" href="<?=$url[0];?>"><?=$tit[0];?></a></h1>
						</td>
					</tr>
					<tr>
						<td id="Imagen1" height="200px" valign="top" style="padding: 2px 5px 5px 5px;"><a style="color: #FF114d" href="<?=$tit[0];?>"><img src="<?=$post_image[0];?>" width="297" height="208"/></a>
						</td>
                    </tr>
                </table>
            </div>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
				...
				<tr>
                        <td height="95" valign="top" style="padding: 5px 5px 0 5px; width: 294px;">
						<h1 id="Titulo2" style="color: #FF114d; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #FF114d" href="<?=$url[1];?>"><?=$tit[1];?></a></h1>
						</td>
					</tr>
					<tr>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="310" height="300" bgcolor="#f6f6f6" valign="top">                    
					<tr>
						...
						<h1 id="Titulo3" style="color: #FF114d; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #FF114d" href="<?=$url[2];?>"><?=$tit[2];?></a></h1></td></tr>
					<tr>
...
<!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
                <table width="310" height="300" bgcolor="#f6f6f6" valign="top">                    
					<tr>
                        <td height="95" valign="top" style="padding: 5px 5px 0 5px;">
							<h1 id="Titulo4" style="color: #FF114d; text-align: left; font-size: 22px; font-family: Arial; font-weight: bold; line-height: 120%; margin: 0"><a style="color: #FF114d" href="<?=$url[3];?>"><?=$tit[3];?></a></h1></td></tr>
...
<!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top; margin-top: 3px;">
				...
				<tr>
					...
					<td id="Titulo5" height="60" valign="top" style="width: 260px; text-align: left"><a style="color: #FF114d" href="<?=$url[4];?>"><span id="Titulo5" style="color: #FF114d"><?=$tit[4];?></span></a></td>
				</tr>
				<tr>
					...
					<td id="Titulo6" height="60" valign="top" style="width: 260px; text-align: left"><a style="color: #FF114d" href="<?=$url[5];?>"><span id="Titulo6" style="color: #FF114d"><?=$tit[5];?></span></a></td>
				</tr>
				<tr>
					...
					<td id="Titulo7" height="60" valign="top" style="width: 260px; padding: 0 5px 0 5px; text-align: left"><a style="color: #FF114d" href="<?=$url[6];?>"><span id="Titulo7" style="color: #FF114d"><?=$tit[6];?></span></a></td>
				</tr>
				<tr>
					...
					<td id="Titulo8" height="60" valign="top" style="width: 260px; height: 25%; text-align: left"><a style="color: #FF114d" href="<?=$url[7];?>"><span id="Titulo8" style="color: #FF114d"><?=$tit[7];?></span></a></td>
				</tr>
			</table>
            </div>
            <!--[if (gte mso 9)|(IE)]>
            ...
            <div style="width: 320px; display: inline-block; vertical-align: top;">
                <table width="310">
                    <tr>
						...
						<a style="color: #FF114d" href="http://www.tynmagazine.com/" target="blank"><span style="color: #FF114d">TYN MAGAZINE</a></span>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #FF114d" href="http://www.tynchannel.com/" target="blank"><span style="color: #FF114d">TYN CHANNEL</a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #FF114d" href="http://www.tyniot.com/" target="blank"><span style="color: #FF114d">TYN IoT</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #FF114d" href="http://www.tynmobile.com/" target="blank"><span style="color: #FF114d">TYN MOBILE</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #FF114d" href="http://www.tynsecurity.com/" target="blank"><span style="color: #FF114d">TYN SECURITY</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #FF114d" href="http://www.tyninvestment.com/" target="blank"><span style="color: #FF114d">TYN INVESTMENT</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #FF114d" href="http://www.tyncloud.com/" target="blank"><span style="color: #FF114d">TYN CLOUD</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #FF114d" href="http://www.tynentrepreneurs.com/" target="blank"><span style="color: #FF114d">TYN ENTREPRENEURS</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #FF114d" href="http://www.tyninvestment.com/" target="blank"><span style="color: #FF114d">TYN MOBILE MONEY</span></a>
						<span style="color: #000">&nbsp;&bull;&nbsp;</span>
						<a style="color: #FF114d" href="http://www.tynmobilemoney.com/" target="blank"><span style="color: #FF114d">TYN BRASIL</span></a></p>
						</td>
                    </tr>
                </table>
            </div>
...
document.getElementById("Titulo1").innerHTML = '<a style="color: #FF114d" href="' + url[SelCombo1] + '">' + tit[SelCombo1] + '</a>';
...
document.getElementById("Titulo2").innerHTML = '<a style="color: #FF114d" href="' + url[SelCombo2] + '">' + tit[SelCombo2] + '</a>';
...
document.getElementById("Titulo3").innerHTML = '<a style="color: #FF114d" href="' + url[SelCombo3] + '">' + tit[SelCombo3] + '</a>';
...
document.getElementById("Titulo4").innerHTML = '<a style="color: #FF114d" href="' + url[SelCombo4] + '">' + tit[SelCombo4] + '</a>';
...
document.getElementById("Titulo5").innerHTML = '<a style="color: #FF114d" href="' + url[SelCombo5] + '">' + tit[SelCombo5] + '</a>';
...
document.getElementById("Titulo6").innerHTML = '<a style="color: #FF114d" href="' + url[SelCombo6] + '">' + tit[SelCombo6] + '</a>';
...
document.getElementById("Titulo7").innerHTML = '<a style="color: #FF114d" href="' + url[SelCombo7] + '">' + tit[SelCombo7] + '</a>';
...
document.getElementById("Titulo8").innerHTML = '<a style="color: #FF114d" href="' + url[SelCombo8] + '">' + tit[SelCombo8] + '</a>';
