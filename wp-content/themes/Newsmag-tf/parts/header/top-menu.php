    ...
    if (td_util::get_option('tds_login_sign_in_widget') == 'show') {
        ...
        if ( is_user_logged_in() ) {
            ...
            echo '<ul class="top-header-menu td_ul_logout">
                        ...
                        '</li>
                        <li class="menu-item">
                            <a href="' . wp_logout_url(home_url( '/' )) . '">' . __td("Cerrar sesión") . '</a>
                        </li>
                 </ul>';
        } else {
            ...
            echo '
                <ul class="top-header-menu td_ul_login">
                	<li class="menu-item"><a class="menu-item" href="/login">' . __td("Iniciar sesión") . $td_user_join . '</a><span class="td-sp-ico-login td_sp_login_ico_style"></span></li>
                	<li class="menu-item"><a class="menu-item" href="/registro">' . __td("Registrarme") . $td_user_join . '</a><span class="td-sp-ico-login td_sp_login_ico_style"></span></li>
                </ul>
