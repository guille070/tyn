	...
	class Custom_Banners_GoldPlugins_BikeShed
	{
		...
		function extract_inline_input($input)
		{
			...
			if ($start_pos !== FALSE && $end_pos !== FALSE)
			{
				...
				$inline_input .= '<input type="text" name="' . esc_attr($inline_field_name) . '" value="' . esc_attr($value) . '" />';
			...
			<div class="bikeshed bikeshed_checkbox">
				<div class="checkbox_wrapper">
					<label for="<?php echo esc_attr( $field_name ); ?>">
						<input type="checkbox" value="<?php echo esc_attr($options['value']); ?>" name="<?php echo esc_attr( $field_name ); ?>" id="<?php echo esc_attr( $field_id ); ?>" <?php echo ($options['checked'] ? 'checked="checked"' : ''); ?> <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?>>
						<?php echo esc_html($options['inline_label']); ?>
					</label>
			...
			<div class="bikeshed bikeshed_radio">
				<div class="radio_wrapper">
					...
					<p class="radio_option">
						<label>
							<input type="radio" <?php if($options['value'] == $value): echo 'checked="checked"'; endif; ?> class="tog" value="<?php echo esc_attr( $value ); ?>" name="<?php echo esc_attr( $field_name ); ?>"  <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?>/>
...
?>	
			<div class="bikeshed bikeshed_textarea">
				<div class="textarea_wrapper">
					<textarea name="<?php echo esc_attr( $field_name ); ?>" id="<?php echo esc_attr( $field_id ); ?>" rows="4" <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?>><?php echo htmlentities($options['value']); ?></textarea>
				</div>
				<?php if(!empty($options['description'])): ?>
				<p class="description"><?php _e($options['description']);?></p>
				<?php endif; ?>				
...
?>	
			<div class="bikeshed bikeshed_text">
				<div class="text_wrapper">
					...
					?>
					<input type="text" name="<?php echo esc_attr( $field_name ); ?>" id="<?php echo esc_attr( $field_id ); ?>" value="<?php echo htmlentities($options['value']); ?>" <?php echo $class_attr; ?> <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?> />
				</div>
				<?php if(!empty($options['description'])): ?>
				<p class="description"><?php _e($options['description']);?></p>
				<?php endif; ?>				
...
?>	
			<div class="bikeshed bikeshed_select">
				<div class="select_wrapper">
					<select name="<?php echo esc_attr( $select_name ); ?>" id="<?php echo esc_attr( $select_id ); ?>" <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?>>	
						<?php foreach($options['options'] as $value => $name): ?>
						<option value="<?php echo esc_attr( $value ); ?>" <?php if($options['value'] == $value): echo 'selected="selected"'; endif; ?>><?php echo esc_attr( $name ); ?></option>
						<?php endforeach; ?>
					</select>
				</div>
				<?php if(!empty($options['description'])): ?>
				...
				<div class="select_wrapper">
					<select name="<?php echo esc_attr( $select_name ); ?>" id="<?php echo esc_attr( $select_id ); ?>" <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?>>	
						<?php foreach($options['options'] as $group_slug => $group_options): ?>
							...
							<optgroup label="<?php echo esc_attr($first_item); ?>">
								...
								?>
								<option value="<?php echo esc_attr( $value ); ?>" <?php if($disabled): echo 'disabled="disabled"'; endif; ?> <?php if($options['value'] == $value): echo 'selected="selected"'; endif; ?>><?php echo esc_attr( $name ); ?></option>
								<?php endforeach; ?>
							</optgroup>
						<?php endforeach; ?>
					</select>
...
?>	
			<div class="bikeshed bikeshed_color">
				<div class="color_picker_wrapper">
					<input data-default-color="<?php echo esc_attr($options['default_color']); ?>" type="text" name="<?php echo esc_attr( $color_name ); ?>" id="<?php echo esc_attr( $color_id ); ?>" class="wp-color-picker" value="<?php echo esc_attr($options['value']); ?> " <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?>/>
				</div>
				<?php if(!empty($options['description'])): ?>
				<p class="description"><?php _e($options['description']);?></p>
				<?php endif; ?>				
...
?>	
			<div class="bikeshed bikeshed_typography">
				<div class="select_wrapper font_size_select_wrapper">
					<select name="<?php echo esc_attr($font_size_name); ?>" id="<?php echo esc_attr( $font_size_id ); ?>" class="font_size_select">
						...
						<option value="<?php echo esc_attr( $font_size ); ?>" <?php echo $selected; ?>><?php echo esc_attr( $font_size ); ?>px</option>
						<?php endforeach; ?>
					</select>
				</div>
				<div class="select_wrapper font_family_select_wrapper">
					<select name="<?php echo esc_attr( $font_family_name ); ?>" id="<?php echo esc_attr( $font_family_id ); ?>" class="font_family_select">
						...
						<?php endif; ?>
							...
							<option value="<?php echo esc_attr( $family ); ?>" <?php echo $selected; ?>><?php echo esc_attr( $family ); ?></option>
							<?php endforeach; ?>
						<?php if($options['google_fonts']): ?>
						</optgroup>
						<?php endif; ?>
						...
						<optgroup label="Google Fonts">
							...
							<option value="google:<?php echo esc_attr( $family ); ?>" <?php echo $selected; ?>><?php echo esc_attr( $family ); ?></option>
							<?php endforeach; ?>
						</optgroup>
						<?php endif; ?>
					</select>
				...
				<div class="select_wrapper font_style_select_wrapper">
					<select name="<?php echo esc_attr($font_style_name); ?>" id="<?php echo esc_attr( $font_style_id ); ?>" class="font_style_select">
						...
						<option value="<?php echo esc_attr( $style ); ?>" <?php echo $selected; ?>><?php echo esc_attr( $style ); ?></option>
						<?php endforeach; ?>
					</select>
				</div>
				<div class="color_picker_wrapper">
					<?php if (empty($options['default_color'])): ?>
					<input type="text" name="<?php echo esc_attr( $font_color_name ); ?>" id="<?php echo esc_attr( $font_color_id ); ?>" class="wp-color-picker" value="<?php echo esc_attr($values['font_color']); ?>" />
					<?php else: ?>
					<input data-default-color="<?php echo esc_attr($options['default_color']); ?>" type="text" name="<?php echo esc_attr( $font_color_name ); ?>" id="<?php echo esc_attr( $font_color_id ); ?>" class="wp-color-picker" value="<?php echo esc_attr($values['font_color']); ?>" />
					<?php endif; ?>
				</div>
				<?php if(!empty($options['description'])): ?>
				<p class="description"><?php _e($options['description']);?></p>
